...
public class PeternakRepository {
    ...
    public List<Peternak> saveAll(List<Peternak> peternakList) throws IOException {
        ...
        for (Peternak peternak : peternakList) {
            try {
                ...
                System.err.println("Failed to insert record for NIK: " + peternak.getNikPeternak() + ", Error: " + e.getMessage());
            }
        }
    ...
    public Peternak findById(String peternakId) throws IOException {
        ...
        return client.getDataByColumn(tableUsers.toString(), columnMapping, "main", "idPeternak", peternakId, Peternak.class);
    }
...
//    }
    ...
    public boolean existsByNikPeternak(String nikPeternak) throws IOException {
        ...
        Peternak peternak = client.getDataByColumn(tablePeternak.toString(), columnMapping, "main", "nikPeternak", nikPeternak, Peternak.class);
    ...
    public boolean existsByEmail(String email) throws IOException {
        ...
        Peternak peternak = client.getDataByColumn(tablePeternak.toString(), columnMapping, "main", "email", email, Peternak.class);
    ...
    public boolean existsByNoTelepon(String noTelepon) throws IOException {
        ...
        Peternak peternak = client.getDataByColumn(tablePeternak.toString(), columnMapping, "main", "noTelepon", noTelepon, Peternak.class);
