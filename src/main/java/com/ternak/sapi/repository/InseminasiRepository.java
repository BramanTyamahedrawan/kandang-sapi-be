...
public class InseminasiRepository {
    ...
    public Inseminasi save(Inseminasi inseminasi) throws IOException {
        ...
        if (inseminasi.getLokasi() != null) {
            client.insertRecord(tableInseminasi, rowKey, "main", "lokasi", inseminasi.getLokasi());
        }
        if (inseminasi.getProvinsi() != null) {
            client.insertRecord(tableInseminasi, rowKey, "main", "provinsi", inseminasi.getProvinsi());
        }
        if (inseminasi.getKabupaten() != null) {
            client.insertRecord(tableInseminasi, rowKey, "main", "kabupaten", inseminasi.getKabupaten());
        }
        if (inseminasi.getKecamatan() != null) {
            client.insertRecord(tableInseminasi, rowKey, "main", "kecamatan", inseminasi.getKecamatan());
        }
        if (inseminasi.getDesa() != null) {
            client.insertRecord(tableInseminasi, rowKey, "main", "desa", inseminasi.getDesa());
        }
        if (inseminasi.getIb1() != null) {
            client.insertRecord(tableInseminasi, rowKey, "main", "ib", inseminasi.getIb1());
        }
        if (inseminasi.getIb2() != null) {
            client.insertRecord(tableInseminasi, rowKey, "main", "ib", inseminasi.getIb2());
        }
        if (inseminasi.getIb3() != null) {
            client.insertRecord(tableInseminasi, rowKey, "main", "ib", inseminasi.getIb3());
        }
        ...
        if (inseminasi.getHewan().getIdHewan() != null) {
            ...
            try {
                ...
                if (inseminasi.getPeternak() != null) {
                    ...
                    if (peternak.getIdPeternak() != null) {
                        client.insertRecord(tableInseminasi, safeString(inseminasi.getIdInseminasi()), "peternak",
                                "idPeternak",
                ...
                if (inseminasi.getPetugas() != null) {
                    ...
                    if (petugas.getNamaPetugas() != null) {
                        client.insertRecord(tableInseminasi, safeString(inseminasi.getIdInseminasi()), "petugas",
                                "nikPetugas",
                        ...
                        client.insertRecord(tableInseminasi, safeString(inseminasi.getIdInseminasi()), "petugas", "job",
                ...
                if (inseminasi.getHewan() != null) {
                    ...
                    client.insertRecord(tableInseminasi, safeString(inseminasi.getIdInseminasi()), "hewan", "idHewan",
                            safeString(hewan.getIdHewan()));
                    client.insertRecord(tableInseminasi, safeString(inseminasi.getIdInseminasi()), "hewan",
                    ...
                    client.insertRecord(tableInseminasi, safeString(inseminasi.getIdInseminasi()), "hewan", "sex",
                            safeString(hewan.getSex()));
                    client.insertRecord(tableInseminasi, safeString(inseminasi.getIdInseminasi()), "hewan", "umur",
                ...
                client.insertRecord(tableInseminasi, rowKey, "main", "lokasi", safeString(inseminasi.getLokasi()));
                client.insertRecord(tableInseminasi, rowKey, "main", "provinsi", safeString(inseminasi.getProvinsi()));
                client.insertRecord(tableInseminasi, rowKey, "main", "kabupaten",
                        safeString(inseminasi.getKabupaten()));
                client.insertRecord(tableInseminasi, rowKey, "main", "kecamatan",
                        safeString(inseminasi.getKecamatan()));
                client.insertRecord(tableInseminasi, rowKey, "main", "desa", safeString(inseminasi.getDesa()));
                client.insertRecord(tableInseminasi, rowKey, "main", "ib1", safeString(inseminasi.getIb1()));
                client.insertRecord(tableInseminasi, rowKey, "main", "ib2", safeString(inseminasi.getIb2()));
                client.insertRecord(tableInseminasi, rowKey, "main", "ib3", safeString(inseminasi.getIb3()));
                client.insertRecord(tableInseminasi, rowKey, "main", "ibLain", safeString(inseminasi.getIbLain()));
                ...
                client.insertRecord(tableInseminasi, rowKey, "main", "produsen", safeString(inseminasi.getProdusen()));

                System.out.println(
                        "Data berhasil disimpan ke HBase dengan ID Inseminasi: " + inseminasi.getIdInseminasi());

            } catch (Exception e) {
                failedRows.add(inseminasi.getIdInseminasi());
                System.err.println(
                        "Failed to insert record for ID: " + inseminasi.getIdInseminasi() + ", Error: "
                                + e.getMessage());
            }
        }
        if (!failedRows.isEmpty()) {
            throw new IOException("Failed to save records for ID Inseminasi: " + String.join(", ", failedRows));
        }
        ...
        for (Inseminasi inseminasi : inseminasiList) {
            try {
                ...
                client.insertRecord(tableInseminasi, rowKey, "main", "tanggalIB",
                        safeString(inseminasi.getTanggalIB()));
                client.insertRecord(tableInseminasi, rowKey, "main", "lokasi", safeString(inseminasi.getLokasi()));
                // client.insertRecord(tableInseminasi, rowKey, "main", "provinsi",
                // safeString(inseminasi.getProvinsi()));
                // client.insertRecord(tableInseminasi, rowKey, "main", "kabupaten",
                // safeString(inseminasi.getKabupaten()));
                // client.insertRecord(tableInseminasi, rowKey, "main", "kecamatan",
                // safeString(inseminasi.getKecamatan()));
                // client.insertRecord(tableInseminasi, rowKey, "main", "desa",
                // safeString(inseminasi.getDesa()));
                client.insertRecord(tableInseminasi, rowKey, "main", "ib1", safeString(inseminasi.getIb1()));
                client.insertRecord(tableInseminasi, rowKey, "main", "ib2", safeString(inseminasi.getIb2()));
                client.insertRecord(tableInseminasi, rowKey, "main", "ib3", safeString(inseminasi.getIb3()));
                client.insertRecord(tableInseminasi, rowKey, "main", "ibLain", safeString(inseminasi.getIbLain()));
    ...
    public Inseminasi update(String inseminasiId, Inseminasi inseminasi) throws IOException {
        ...
        if (inseminasi.getIb1() != null) {
            client.insertRecord(tableInseminasi, inseminasiId, "main", "ib", inseminasi.getIb1());
        }
        if (inseminasi.getIdPejantan() != null) {
