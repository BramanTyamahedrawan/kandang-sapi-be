...
public class KelahiranRepository {
    ...
    public Kelahiran save(Kelahiran kelahiran) throws IOException {
        ...
        client.insertRecord(tableKelahiran, rowKey, "inseminasi", "idInseminasi", kelahiran.getInseminasi().getIdInseminasi());
        client.insertRecord(tableKelahiran, rowKey, "inseminasi", "idPejantan", kelahiran.getInseminasi().getIdPejantan());
        client.insertRecord(tableKelahiran, rowKey, "inseminasi", "idPembuatan", kelahiran.getInseminasi().getIdPembuatan());
        client.insertRecord(tableKelahiran, rowKey, "inseminasi", "produsen", kelahiran.getInseminasi().getProdusen());
        client.insertRecord(tableKelahiran, rowKey, "inseminasi", "bangsaPejantan", kelahiran.getInseminasi().getBangsaPejantan());
        client.insertRecord(tableKelahiran, rowKey, "inseminasi", "ib", kelahiran.getInseminasi().getIb());
        client.insertRecord(tableKelahiran, rowKey, "inseminasi", "tanggalIB", kelahiran.getInseminasi().getTanggalIB());
    ...
    public List<Kelahiran> findKelahiranByPeternak(String peternakId, int size) throws IOException {
        ...
        List<Kelahiran> kelahiran = client.getDataListByColumn(table.toString(), columnMapping, "peternak", "nikPeternak", peternakId, Kelahiran.class, size);
        return kelahiran;
    }
    ...
    public List<Kelahiran> findKelahiranByPetugas(String petugasId, int size) throws IOException {
        ...
        return client.getDataListByColumn(table.toString(), columnMapping, "petugas", "nikPetugas", petugasId, Kelahiran.class, size);
    }
    ...
    public List<Kelahiran> findKelahiranByHewan(String hewanId, int size) throws IOException {
        ...
        return client.getDataListByColumn(table.toString(), columnMapping, "hewan", "kodeEartagNasional", hewanId, Kelahiran.class, size);
    }
    ...
    public Kelahiran update(String kelahiranId, Kelahiran kelahiran) throws IOException {
        ...
        client.insertRecord(tableKelahiran, kelahiranId, "inseminasi", "idInseminasi", kelahiran.getInseminasi().getIdInseminasi());
        client.insertRecord(tableKelahiran, kelahiranId, "inseminasi", "idPejantan", kelahiran.getInseminasi().getIdPejantan());
        client.insertRecord(tableKelahiran, kelahiranId, "inseminasi", "idPembuatan", kelahiran.getInseminasi().getIdPembuatan());
        client.insertRecord(tableKelahiran, kelahiranId, "inseminasi", "bangsaPejantan", kelahiran.getInseminasi().getBangsaPejantan());
        client.insertRecord(tableKelahiran, kelahiranId, "inseminasi", "produsen", kelahiran.getInseminasi().getProdusen());
        client.insertRecord(tableKelahiran, kelahiranId, "inseminasi", "ib", kelahiran.getInseminasi().getIb());
        client.insertRecord(tableKelahiran, kelahiranId, "inseminasi", "tanggalIB", kelahiran.getInseminasi().getTanggalIB());
