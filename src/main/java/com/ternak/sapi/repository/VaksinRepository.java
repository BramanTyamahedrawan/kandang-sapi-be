        ...
        for (Vaksin vaksin : vaksinList) {
            try {
                ...
                if (vaksin.getJenisVaksin() != null) {
                    ...
                    if(jenisVaksin.getJenisVaksin() != null){
                        client.insertRecord(tableVaksin, safeString(vaksin.getIdVaksin()), "jenisVaksin", "idJenisVaksin",
                                safeString(jenisVaksin.getIdJenisVaksin()));
                        client.insertRecord(tableVaksin, safeString(vaksin.getIdVaksin()), "jenisVaksin", "jenisVaksin",
                                safeString(jenisVaksin.getJenisVaksin()));
                    }
                }
                if (vaksin.getNamaVaksin() != null) {
                    NamaVaksin namaVaksin = vaksin.getNamaVaksin();
                    if(namaVaksin.getNamaVaksin() != null){
                    client.insertRecord(tableVaksin, safeString(vaksin.getIdVaksin()), "namaVaksin", "idNamaVaksin",
                            safeString(namaVaksin.getIdNamaVaksin()));
                    client.insertRecord(tableVaksin, safeString(vaksin.getIdVaksin()), "namaVaksin", "namaVaksin",
