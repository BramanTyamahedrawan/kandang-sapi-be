...
public class VaksinRepository {
        ...
        public List<Vaksin> findVaksinByNamaVaksin(String namaVaksin, int size) throws IOException {
                HBaseCustomClient client = new HBaseCustomClient(conf);
                ...
                return client.getDataListByColumn(table.toString(), columnMapping, "namaVaksin", "namaVaksin",
                                namaVaksin,
                                Vaksin.class, size);
        }

        public List<Vaksin> findVaksinByJenisVaksin(String jenisVaksin, int size) throws IOException {
                HBaseCustomClient client = new HBaseCustomClient(conf);
                ...
                return client.getDataListByColumn(table.toString(), columnMapping, "jenisVaksin", "jenisVaksin",
                                jenisVaksin,
                                Vaksin.class, size);
        }
                ...
                for (Vaksin vaksin : vaksinList) {
                        try {
                                ...
                                if (vaksin.getNamaVaksin() != null) {
                                        ...
                                        client.insertRecord(tableVaksin, rowKey, "namaVaksin", "namaVaksin",
