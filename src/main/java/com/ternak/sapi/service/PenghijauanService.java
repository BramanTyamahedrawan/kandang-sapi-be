...
public class PenghijauanService {
    ...
    // LoggerFactory.getLogger(PenghijauanService.class);
    ...
    public DefaultResponse<Penghijauan> getPenghijauanById(String penghijauanId) throws IOException {
        ...
        return new DefaultResponse<>(penghijauanResponse.isValid() ? penghijauanResponse : null,
                penghijauanResponse.isValid() ? 1 : 0, "Successfully get data");
    }

    public Penghijauan updatePenghijauan(String penghijauanId, PenghijauanRequest penghijauanRequest)
            throws IOException {
        Penghijauan penghijauan = new Penghijauan();
        if (penghijauanRequest.getNamaTempat() != null) {
            penghijauan.setIdPenghijauan(penghijauanRequest.getIdPenghijauan());
