 ...
 * @author reyza1
 */
public class PenghijauanRequest {
...
public PenghijauanRequest(){
    
}

public PenghijauanRequest(String idPenghijauan, String namaTempat, String lokasi, String file_path){
