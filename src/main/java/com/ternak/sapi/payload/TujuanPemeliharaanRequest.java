...
public class TujuanPemeliharaanRequest {

    private String idTujuanPemeliharaan;
    private String tujuanPemeliharaan;
    private String deskripsi;

    public TujuanPemeliharaanRequest() {
    }

    public TujuanPemeliharaanRequest(String idTujuanPemeliharaan, String tujuanPemeliharaan, String deskripsi) {
