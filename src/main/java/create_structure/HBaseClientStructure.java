...
public class HBaseClientStructure {
        ...
        public static void main(String[] args) throws IOException {
                ...
                // client.insertRecord(tablePetugas, "PTG001", "main", "namaPetugas",
                //// "sunaryam");
                // client.insertRecord(tablePetugas, "PTG001", "main", "noTelp", "123456789");
                // client.insertRecord(tablePetugas, "PTG001", "main", "email",
                //// "petugas1@gmail.com");
                ...
                // client.insertRecord(tablePetugas, "PTG002", "main", "namaPetugas",
                // "sunardi");
                // client.insertRecord(tablePetugas, "PTG002", "main", "noTelp", "987654321");
                // client.insertRecord(tablePetugas, "PTG002", "main", "email",
                // "petugas2@gmail.com");
                //// client.insertRecord(tablePetugas, "PTG002", "user", "id", "USR003"); //
                // Assign user with ID USR003 as the admin who created this petugas
                ...
                // client.insertRecord(tablePetugas, "PTG003", "main", "email",
                // "petugas3@gmail.com");
                //// client.insertRecord(tablePetugas, "PTG003", "user", "id", "USR001"); //
                // Assign user with ID USR001 as the admin who created this petugas
                ...
                // client.insertRecord(tablePeternak, "PTK001", "main", "nikPeternak",
                // "Ptk001");
                // client.insertRecord(tablePeternak, "PTK001", "main", "namaPeternak",
                // "peternak1");
                ...
                // client.insertRecord(tablePeternak, "PTK001", "main", "tanggalPendaftaran",
                // "22/02/2022");
                // client.insertRecord(tablePeternak, "PTK001", "petugas", "nikPetugas",
                // "PTG001");
                // client.insertRecord(tablePeternak, "PTK001", "petugas", "namaPetugas",
                // "sunaryam");
                // client.insertRecord(tablePeternak, "PTK001", "petugas", "noTelp",
                // "123456789");
                // client.insertRecord(tablePeternak, "PTK001", "petugas", "email",
                // "petugas1@gmail.com");
                //
                // client.insertRecord(tablePeternak, "PTK002", "main", "idPeternak", "PTK002");
                // client.insertRecord(tablePeternak, "PTK002", "main", "nikPeternak",
                // "Ptk002");
                // client.insertRecord(tablePeternak, "PTK002", "main", "namaPeternak",
                // "peternak2");
                ...
                // client.insertRecord(tablePeternak, "PTK002", "main", "tanggalPendaftaran",
                // "22/02/2022");
                // client.insertRecord(tablePeternak, "PTK002", "petugas", "nikPetugas",
                // "PTG001");
                // client.insertRecord(tablePeternak, "PTK002", "petugas", "namaPetugas",
                // "sunaryam");
                // client.insertRecord(tablePeternak, "PTK002", "petugas", "noTelp",
                // "123456789");
                // client.insertRecord(tablePeternak, "PTK002", "petugas", "email",
                // "petugas1@gmail.com");
                // // Insert Jurusan
                // client.insertRecord(tableDepartment, "DP001", "main", "id", "DP001");
                // client.insertRecord(tableDepartment, "DP001", "main", "name", "Jurusan
                // Teknologi Informasi");
                // client.insertRecord(tableDepartment, "DP001", "main", "description", "Ini
                // merupakan jurusan untuk mahasiswa informatika");
                // client.insertRecord(tableDepartment, "DP001", "detail", "created_by",
                // "Doyatama");
                //
                // client.insertRecord(tableDepartment, "DP002", "main", "id", "DP002");
                // client.insertRecord(tableDepartment, "DP002", "main", "name", "Jurusan Teknik
                // Mesin");
                // client.insertRecord(tableDepartment, "DP002", "main", "description", "Ini
                // merupakan jurusan untuk mahasiswa teknik mesin");
                // client.insertRecord(tableDepartment, "DP002", "detail", "created_by",
                // "Doyatama");
                //
                // // Insert Prodi
                // client.insertRecord(tableStudyProgram, "SP001", "main", "id", "SP001");
                // client.insertRecord(tableStudyProgram, "SP001", "main", "name", "D4 Teknik
                // Informatika");
                // client.insertRecord(tableStudyProgram, "SP001", "main", "description", "Ini
                // merupakan prodi untuk mahasiswa informatika");
                // client.insertRecord(tableStudyProgram, "SP001", "department", "id", "DP001");
                // client.insertRecord(tableStudyProgram, "SP001", "department", "name",
                // "Jurusan Teknologi Informasi");
                // client.insertRecord(tableStudyProgram, "SP001", "detail", "created_by",
                // "Doyatama");
                //
                // client.insertRecord(tableStudyProgram, "SP002", "main", "id", "SP002");
                // client.insertRecord(tableStudyProgram, "SP002", "main", "name", "D3 Manajemen
                // Informatika");
                // client.insertRecord(tableStudyProgram, "SP002", "main", "description", "Ini
                // merupakan prodi untuk mahasiswa informatika");
                // client.insertRecord(tableStudyProgram, "SP002", "department", "id", "DP002");
                // client.insertRecord(tableStudyProgram, "SP002", "department", "name",
                // "Jurusan Teknik Mesin");
                // client.insertRecord(tableStudyProgram, "SP002", "detail", "created_by",
                // "Doyatama");
                //
                //
                //
                ...
                // client.insertRecord(tableLearningMethod, "MP001", "main", "name", "Contextual
                ...
                // client.insertRecord(tableAssessmentCriteria, "KP001", "main", "name",
                // "Ketepatan");
                // client.insertRecord(tableAssessmentCriteria, "KP001", "main", "description",
                // "Ketepatan dalam pengumpulan tugas dan kehadiran di kelas");
                // client.insertRecord(tableAssessmentCriteria, "KP001", "detail", "created_by",
                // "Doyatama");
                //
                // client.insertRecord(tableAssessmentCriteria, "KP002", "main", "id", "KP002");
                // client.insertRecord(tableAssessmentCriteria, "KP002", "main", "name",
                // "Penugasan");
                // client.insertRecord(tableAssessmentCriteria, "KP002", "main", "description",
                // "Penilaian didasarkan dari penugasan yang diberikan dosen");
                // client.insertRecord(tableAssessmentCriteria, "KP002", "detail", "created_by",
                // "Doyatama");
                //
                // // Insert Bentuk Penilaian
                // client.insertRecord(tableAppraisalForm, "AF001", "main", "id", "AF001");
                // client.insertRecord(tableAppraisalForm, "AF001", "main", "name", "Keaktifan
                // diskusi kelompok meliputi bertanya dan menjawab");
                // client.insertRecord(tableAppraisalForm, "AF001", "main", "description",
                // "Keaktifan diskusi kelompok");
                // client.insertRecord(tableAppraisalForm, "AF001", "detail", "created_by",
                // "Doyatama");
                //
                // client.insertRecord(tableAppraisalForm, "AF002", "main", "id", "AF002");
                // client.insertRecord(tableAppraisalForm, "AF002", "main", "name", "Ketepatan
                // jawaban tugas");
                // client.insertRecord(tableAppraisalForm, "AF002", "main", "description",
                // "Ketepatan jawaban yang diberikan dari tugas");
                // client.insertRecord(tableAppraisalForm, "AF002", "detail", "created_by",
                // "Doyatama");
                //
                ...
                // client.insertRecord(tableSubjectGroup, "SG001", "main", "description", "ini
                // kelompok big data");
                // client.insertRecord(tableSubjectGroup, "SG001", "detail", "created_by",
                // "Doyatama");
                //
                // client.insertRecord(tableSubjectGroup, "SG002", "main", "id", "SG002");
                // client.insertRecord(tableSubjectGroup, "SG002", "main", "name", "Artificial
                // Inteligent");
                // client.insertRecord(tableSubjectGroup, "SG002", "main", "description", "ini
                // kelompok AI");
                // client.insertRecord(tableSubjectGroup, "SG002", "detail", "created_by",
                // "Doyatama");
                //
                // client.insertRecord(tableSubjectGroup, "SG003", "main", "id", "SG003");
                // client.insertRecord(tableSubjectGroup, "SG003", "main", "name", "Sistem
                // Pendukung Keputusan");
                // client.insertRecord(tableSubjectGroup, "SG003", "main", "description", "ini
                // kelompok SPK");
                // client.insertRecord(tableSubjectGroup, "SG003", "detail", "created_by",
                // "Doyatama");
                //
                // // Insert Subject
                // client.insertRecord(tableSubject, "SB001", "main", "id", "SB001");
                // client.insertRecord(tableSubject, "SB001", "main", "name", "Pemrograman
                // Berbasis Object");
                // client.insertRecord(tableSubject, "SB001", "main", "description", "ini
                // deskripsi dari mata kuliah");
                ...
                // client.insertRecord(tableSubject, "SB001", "study_program", "name", "D4
                // Teknik Informatika");
                // client.insertRecord(tableSubject, "SB001", "subject_group", "id", "SG001");
                // client.insertRecord(tableSubject, "SB001", "subject_group", "name", "Big
                // Data");
                // client.insertRecord(tableSubject, "SB001", "detail", "created_by",
                // "Doyatama");
                //
                // client.insertRecord(tableSubject, "SB002", "main", "id", "SB002");
                // client.insertRecord(tableSubject, "SB002", "main", "name", "Pemrograman
                // Lanjut");
                // client.insertRecord(tableSubject, "SB002", "main", "description", "ini
                // deskripsi dari mata kuliah");
                ...
                // client.insertRecord(tableSubject, "SB002", "study_program", "name", "D4
                // Teknik Informatika");
                // client.insertRecord(tableSubject, "SB002", "subject_group", "id", "SG001");
                // client.insertRecord(tableSubject, "SB002", "subject_group", "name", "Big
                // Data");
                // client.insertRecord(tableSubject, "SB002", "detail", "created_by",
                // "Doyatama");
                //
                // // Insert Lectures
                // client.insertRecord(tableLecture, "LEC001", "main", "id", "LEC001");
                // client.insertRecord(tableLecture, "LEC001", "main", "address",
                // "dosen@gmail.com");
                // client.insertRecord(tableLecture, "LEC001", "main", "date_born", "dosen");
                // client.insertRecord(tableLecture, "LEC001", "main", "gender",
                // "$2a$10$SDRWMUk.2fnli0GTmqodJexjRksTw0En98dU8fdKsw7nTbZzMrj.2"); // password
                ...
                // client.insertRecord(tableLecture, "LEC002", "study_program", "name", "D4
                // Teknik Informatika");
                // client.insertRecord(tableLecture, "LEC002", "user", "id", "USR002");
                // client.insertRecord(tableLecture, "LEC002", "user", "name", "dosen");
                // client.insertRecord(tableLecture, "LEC002", "user", "email",
                // "dosen@gmail.com");
                // client.insertRecord(tableLecture, "LEC002", "user", "username", "dosen");
                // client.insertRecord(tableLecture, "LEC002", "detail", "created_by",
                // "Doyatama");
                //
                // // Learning Media
                // // Software
                ...
                // client.insertRecord(tableLearningMedia, "LM001", "main", "description", "ini
                // deskripsi netbeans");
                // client.insertRecord(tableLearningMedia, "LM001", "main", "type", "1");
                // client.insertRecord(tableLearningMedia, "LM001", "detail", "created_by",
                // "Doyatama");
                //
                // // Hardware
                // client.insertRecord(tableLearningMedia, "LM002", "main", "id", "LM002");
                // client.insertRecord(tableLearningMedia, "LM002", "main", "name", "PC /
                // Komputer");
                // client.insertRecord(tableLearningMedia, "LM002", "main", "description", "ini
                // deskripsi pc / komputer");
                // client.insertRecord(tableLearningMedia, "LM002", "main", "type", "2");
                // client.insertRecord(tableLearningMedia, "LM002", "detail", "created_by",
                // "Doyatama");
                //
                // // RPS
                ...
                // client.insertRecord(tableRPS, "RPS001", "main", "cpl_prodi", "Dummy CPL
                // Prodi");
                // client.insertRecord(tableRPS, "RPS001", "main", "cpl_mk", "Dummy CPL MK");
                // client.insertRecord(tableRPS, "RPS001", "study_program", "id", "SP001");
                // client.insertRecord(tableRPS, "RPS001", "study_program", "name", "D4 Teknik
                // Informatika");
                // client.insertRecord(tableRPS, "RPS001", "subject", "id", "SB001");
                // client.insertRecord(tableRPS, "RPS001", "subject", "name", "Pemrograman
                // Berbasis Object");
                ...
                // client.insertRecord(tableRPS, "RPS001", "detail", "created_at",
                // instant.toString());
                //
                // // RPS Detail
                ...
                // client.insertRecord(tableRPSDetail, "RPSD001", "main", "sub_cp_mk", "Dummy
                // Sub CP MK");
                // client.insertRecord(tableRPSDetail, "RPSD001", "learning_materials", "lm_1",
                // "Dummy Learning Material");
                // client.insertRecord(tableRPSDetail, "RPSD001", "form_learning", "id",
                // "BP001");
                // client.insertRecord(tableRPSDetail, "RPSD001", "form_learning", "name",
                // "Daring");
                // client.insertRecord(tableRPSDetail, "RPSD001", "assignments", "lm_1", "Dummy
                // Penugasan");
                // client.insertRecord(tableRPSDetail, "RPSD001", "estimated_times", "et_1",
                // "Dummy Estimasi Waktu");
                // client.insertRecord(tableRPSDetail, "RPSD001",
                // "student_learning_experiences", "sle_1", "Dummy Pengalaman Mahasiswa");
                // client.insertRecord(tableRPSDetail, "RPSD001", "assessment_indicators",
                // "ai_1", "Dummy Assessment Indikator");
                // client.insertRecord(tableRPSDetail, "RPSD001", "main", "weight", "3");
                // client.insertRecord(tableRPSDetail, "RPSD001", "detail", "created_by",
                // "Doyatama");
                // client.insertRecord(tableRPSDetail, "RPSD001", "detail", "created_at",
                // instant.toString());
                ...
                // faker.lorem().sentence());
                //// client.insertRecord(tableQuestion, "QST"+i, "main", "question_type",
                // typeQ);
                ...
                //// client.insertRecord(tableQuestion, "QST"+i, "rps_detail", "sub_cp_mk",
                // "Dummy Sub CP MK");
